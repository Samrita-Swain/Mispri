        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-md text-center">
              <div className="inline-block p-4 bg-[#2D7D90] bg-opacity-10 rounded-full mb-4">
                <FaHeart className="text-3xl text-[#2D7D90]" />
              </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md text-center">
              <div className="inline-block p-4 bg-[#2D7D90] bg-opacity-10 rounded-full mb-4">
                <FaLeaf className="text-3xl text-[#2D7D90]" />
              </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md text-center">
              <div className="inline-block p-4 bg-[#2D7D90] bg-opacity-10 rounded-full mb-4">
                <FaSmile className="text-3xl text-[#2D7D90]" />
              </div>
