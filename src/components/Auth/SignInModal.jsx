      ...
      <div className="bg-white rounded-lg overflow-hidden max-w-2xl w-full mx-4 flex">
        ...
        <div className="w-full md:w-2/5 p-8 relative">
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              <div className="relative">
                ...
                <input
                  type="email"
                  placeholder="Email"
                  className="w-full pl-12 pr-4 py-3 text-base border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#2D7D90] focus:border-[#2D7D90]"
                  value={email}
            ...
            <button
              type="submit"
              className="w-full bg-gray-300 text-gray-700 py-3 px-4 rounded-md hover:bg-[#0e4d65] hover:text-white transition duration-200 mb-6 uppercase font-medium text-base"
            >
              Continue
            </button>
          </form>
