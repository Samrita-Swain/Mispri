    ...
    <footer className="pt-8 pb-6">
      <div className="container mx-auto px-4">
        ...
        <div className="fixed bottom-6 right-6 z-50">
          <a
            href="#"
            className="w-12 h-12 rounded-full bg-green-500 flex items-center justify-center text-white shadow-lg hover:bg-green-600 hover:-translate-y-1 transition-all duration-300"
          >
