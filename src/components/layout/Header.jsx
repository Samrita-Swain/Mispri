...
const Header = () => {
  ...
  const moreMenuItems = [
    { id: 1, name: 'Corporate Gifts', icon: <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-[#2D7D90]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7" /></svg>, url: '/corporate-gifts' },
    { id: 2, name: 'My Favourites', icon: <FaHeart className="w-5 h-5 text-[#2D7D90]" />, url: '/favourites' },
    { id: 3, name: 'Refer and Earn', icon: <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-[#2D7D90]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>, url: '/refer-earn', badge: 'New' },
    { id: 4, name: 'Franchise', icon: <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-[#2D7D90]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>, url: '/franchise' },
    { id: 5, name: 'FAQ', icon: <FaQuestion className="w-5 h-5 text-[#2D7D90]" />, url: '/faq' },
    { id: 6, name: 'About Us', icon: <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-[#2D7D90]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>, url: '/about-us' },
    { id: 7, name: 'Sell With Us', icon: <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-[#2D7D90]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" /></svg>, url: '/sell-with-us' },
    { id: 8, name: 'Contact Us', icon: <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-[#2D7D90]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>, url: '/contact-us' },
    { id: 9, name: 'WhatsApp', icon: <FaWhatsapp className="w-5 h-5 text-[#2D7D90]" />, url: '/whatsapp' },
  ];
  ...
  return (
    <>
      ...
      <header className="floweraura-header bg-white shadow-sm fixed top-0 left-0 right-0 z-40 w-full">
        {/* Top Bar */}
        <div className="container mx-auto px-4 py-3">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center w-full justify-between md:hidden">
              <button
                className="text-[#2D7D90] flex items-center justify-center"
                      ...
                      >
                        ...
                        <div className="p-4 flex items-center border-b border-gray-200">
                          ...
                          <div>
                            ...
                            <button onClick={() => { setMobileMoreMenuOpen(false); setSignInModalOpen(true); }} className="text-[#2D7D90] text-sm font-medium">Login in Now!</button>
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <Link to="/favourites" className="mobile-sidebar-item" onClick={() => setMobileMoreMenuOpen(false)}>
                            <FaHeart className="h-5 w-5 mr-3 text-[#2D7D90]" />
            ...
            <div className="hidden md:flex items-center w-full justify-between">
              ...
              {/* Location Selector */}
              <div
                className="flex items-center bg-blue-50 rounded-md px-3 py-1.5 mr-4 cursor-pointer hover:bg-blue-100 transition-colors relative"
              ...
              >
                ...
                <button className="text-[#2D7D90] ml-2">
              ...
              <div className="flex-grow max-w-xl mx-4">
                <form onSubmit={handleSearch} className="flex">
                  <input
                    ...
                    className="w-full py-2 px-4 border border-gray-300 rounded-l-md focus:outline-none focus:ring-1 focus:ring-[#2D7D90] focus:border-[#2D7D90]"
                    value={searchQuery}
                    onChange={(e) => setSearchQuery(e.target.value)}
                  />
                  <button
                    type="submit"
                    className="bg-gray-100 text-gray-600 py-2 px-4 rounded-r-md hover:bg-gray-200 transition duration-200"
                  >
                    <FaSearch />
                  </button>
                </form>
              ...
              <div className="flex items-center space-x-6">
                <Link to="/track-order" className="flex flex-col items-center text-gray-700 hover:text-[#2D7D90]">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mb-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                  </svg>
                  <span className="text-xs">Track Order</span>
                </Link>
                <Link to="/gift-finder" className="flex flex-col items-center text-gray-700 hover:text-[#2D7D90]">
                  <FaGift className="h-5 w-5 mb-1" />
                  <span className="text-xs">Gift Finder</span>
                </Link>
                <Link to="/cart" className="flex flex-col items-center text-gray-700 hover:text-[#2D7D90] relative">
                ...
                <button
                  ...
                  className="flex flex-col items-center text-gray-700 hover:text-[#2D7D90]"
                >
                ...
                >
                  <button
                    ...
                    aria-label="More options"
                  >
                    <FaEllipsisV className="h-5 w-5 mb-1" />
                  ...
                  {desktopMoreMenuOpen && (
                    ...
                    >
                      <div
                        className="more-dropdown-content-desktop w-80 bg-white shadow-lg border border-gray-200 overflow-hidden rounded-md"
                        ...
                        <div>
                          {moreMenuItems.map((item) => (
                            ...
                            >
                              ...
                              {item.badge && (
                                <span className="ml-2 bg-[#2D7D90] text-white text-xs px-2 py-0.5 rounded-full">
                                  {item.badge}
                                </span>
                              )}
                            </Link>
        ...
        <div className="md:hidden bg-blue-50 py-2 px-4 border-t border-blue-100">
            ...
            <ul className="flex flex-row justify-center space-x-6 py-2 overflow-x-auto">
              {menuItems.map((item) => (
                <li key={item.id} className="py-2 whitespace-nowrap">
                  <Link
                    to={item.url}
                    className="text-gray-700 hover:text-[#2D7D90] text-sm font-medium"
                  >
                    {item.name}
                  </Link>
                </li>
              ...
              <div className="p-4 flex items-center border-b border-gray-200">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <button onClick={() => { setMoreMenuOpen(false); setSignInModalOpen(true); }} className="text-[#2D7D90] text-xs font-medium">Sign In</button>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-xl w-full max-w-md mx-4 overflow-hidden">
              ...
              <div className="p-4">
                ...
                <div className="mt-4 flex justify-between items-center">
                  ...
                  <button
                    className="bg-[#2D7D90] text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-[#236A7A] transition-colors"
